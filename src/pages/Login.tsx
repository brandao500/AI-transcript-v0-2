      ...
      <main className="container flex items-center justify-center py-16">
        <Card className="w-full max-w-md shadow-lg border-0">
          <CardHeader className="text-center space-y-4">
            <div className="flex items-center justify-center w-16 h-16 bg-gradient-youtube rounded-2xl mx-auto shadow-glow">
            ...
            <div>
              ...
              <CardDescription>
                Faça login para continuar analisando vídeos
              </CardDescription>
            </div>
          </CardHeader>
